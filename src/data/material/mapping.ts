...
import { headhuntingMaterialList } from "./headhunting";
import { othersMaterialList } from "./others";
import { LMD } from "./lmd";
import { EXP } from "./exp";
...
export const materialNames: Record<string, string> = materialList.reduce(
  (acc, material) => {
