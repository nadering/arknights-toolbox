...
export const orirockCube: Material = {
  ...
  type: "Upgrade",
  tier: 2,
  recipe: [{ material: orirock, count: 3 }],
};
...
export const device: Material = {
  ...
  type: "Upgrade",
  tier: 2,
  recipe: [{ material: damagedDivice, count: 3 }],
};
...
export const sugar: Material = {
  ...
  type: "Upgrade",
  tier: 2,
  recipe: [{ material: sugarSubstitute, count: 3 }],
};
...
export const oriron: Material = {
  ...
  type: "Upgrade",
  tier: 2,
  recipe: [{ material: orironShard, count: 3 }],
};
...
export const polyketon: Material = {
  ...
  type: "Upgrade",
  tier: 2,
  recipe: [{ material: diketon, count: 3 }],
};
...
export const orirockCluster: Material = {
  ...
  type: "Upgrade",
  tier: 3,
  recipe: [{ material: orirockCube, count: 5 }],
};
...
export const integratedDevice: Material = {
  ...
  type: "Upgrade",
  tier: 3,
  recipe: [{ material: device, count: 4 }],
};
...
export const polyesterPack: Material = {
  ...
  type: "Upgrade",
  tier: 3,
  recipe: [{ material: polyester, count: 4 }],
};
...
export const orironCluster: Material = {
  ...
  type: "Upgrade",
  tier: 3,
  recipe: [{ material: oriron, count: 4 }],
};
...
export const aketon: Material = {
  ...
  type: "Upgrade",
  tier: 3,
  recipe: [{ material: polyketon, count: 4 }],
};
...
export const orirockConcentration: Material = {
  ...
  type: "Upgrade",
  tier: 4,
  recipe: [{ material: orirockCluster, count: 4 }],
};
