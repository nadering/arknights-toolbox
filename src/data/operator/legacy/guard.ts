...
/** 가드 오퍼레이터 */
export interface Guard extends LegacyOperator {
  /** 세부 직군 */
  branch?: GuardBranch;
}
...
export const ChenTheDawnstreak: Guard = {
  ...
  name: "첸 더 던스트릭",
  nicknameList: ["삼첸"],
  imageFilename: "ch'en-the-dawnstreak",
  class: "Guard",
  rarity: 6,
  eliteMaterials: {
    "0": [],
...
export const TogawaSakiko: Guard = {
  ...
  preferSkillList: ["초승달의 각성", "보름달의 무도회", "그믐달의 여운"],
  skillUpgradeMaterials: {
    common: {
      "2": [
        {
...
export const Hoederer: Guard = {
  ...
  preferSkillList: ["꺼지지 않는 칼날의 불", "죽음의 연기"],
  skillUpgradeMaterials: {
    common: {
      2: [{ material: skillSummary1, count: 5 }],
      3: [
...
export const Irene: Guard = {
  ...
  moduleList: [
    ...
    { type: "ISW-α", name: "아이린의 특별 한정 배지" },
  ],
  preferModuleList: [
    {
      module: { type: "ISW-α", name: "아이린의 특별 한정 배지" },
      level: 3,
    },
  ],
  moduleMaterials: {
...
/** 브라이오피타 */
export const Bryophyta: Guard = {
  id: 285,
  name: "브라이오피타",
  imageFilename: "bryophyta",
  class: "Guard",
  rarity: 5,
  eliteMaterials: {
    "0": [],
...
/** 모건 */
export const Morgan: Guard = {
  id: 273,
  name: "모건",
  imageFilename: "morgan",
  class: "Guard",
  rarity: 5,
  eliteMaterials: {
    "0": [],
...
const fourStarGuardList: Guard[] = [Windscoot, Humus];
